...
type HelloResponse struct {
	...
	User  *User      `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty"` //引入其它的proto文件定义的对象
...
func (x *HelloResponse) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *HelloResponse) GetData() *anypb.Any {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_pb_hello_proto_rawDesc = []byte{
	...
	,
...
var file_pb_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pb_hello_proto_goTypes = []interface{}{
	(*HelloRequest)(nil),  // 0: pb.HelloRequest
	(*Content)(nil),       // 1: pb.content
	(*HelloResponse)(nil), // 2: pb.HelloResponse
	(*User)(nil),          // 3: pb.User
	(*anypb.Any)(nil),     // 4: google.protobuf.Any
}
var file_pb_hello_proto_depIdxs = []int32{
	3, // 0: pb.HelloResponse.user:type_name -> pb.User
	4, // 1: pb.HelloResponse.data:type_name -> google.protobuf.Any
	0, // 2: pb.Greeter.SayHello:input_type -> pb.HelloRequest
	2, // 3: pb.Greeter.SayHello:output_type -> pb.HelloResponse
